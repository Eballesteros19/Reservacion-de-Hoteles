...
<title>Alquiler de hotel | Detalles del hotel</title>
<!--Bootstrap -->
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Descripción general de la habitacion </a></li>
          
              <li role="presentation"><a href="#accessories" aria-controls="accessculoories" role="tab" data-toggle="tab">Accessories</a></li>
            </ul>
...
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Iniciar sesión para reservar</a>
    ...
    <div class="similar_cars">
      <h3>hoteles que te podrian interesar</h3>
      <div class="row">
<?php 
$bid=$_SESSION['brndid'];
          ...
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
             ...
             <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> camas</li>
                <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> (fecha disponible)</li>
