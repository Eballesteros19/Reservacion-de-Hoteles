    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/stayvibes.jpg" alt="image"/></a> </div>
        </div>
...
echo "Bienvenido al portal de alquiler de hoteles";
 } ?>
          </div>
        </div>
      </div>
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="car-listing.php">Listado de hoteles</a>
