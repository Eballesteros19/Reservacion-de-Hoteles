...
<title>Portal de Hoteles | Listado de hoteles</title>
<!--Bootstrap -->
...
<!-- Fav and touch icons -->
<link rel="stayvibes" sizes="144x144" href="assets/images/favicon-icon/apple-touch-icon-144-precomposed.png">
<link rel="stayvibes" sizes="114x114" href="assets/images/favicon-icon/apple-touch-icon-114-precomposed.html">
<link rel="stayvibes" sizes="72x72" href="assets/images/favicon-icon/apple-touch-icon-72-precomposed.png">
<link rel="stayvibes" href="assets/images/favicon-icon/apple-touch-icon-57-precomposed.png">
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control" name="fueltype">
                  <option>Seleccione el tipo de habitacion</option>
