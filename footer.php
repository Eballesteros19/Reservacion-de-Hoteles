      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="newsletter-form">
            ...
            <p class="subscribed-text">*Enviamos grandes descuentos y ofertas acerca de los hoteles disponibles.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; stayvibes. Reservados todos los derechos.</p>
        </div>
      </div>
    </div>
  </div>
