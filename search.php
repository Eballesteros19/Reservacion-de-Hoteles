...
<title>Reserva de hoteles | Listado de hoteles</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Encuentra tu hotel</h5>
          </div>
...
<?php }} ?>
              ...
              <div class="form-group select">
                <select class="form-control">
                  <option>Seleccione la capacidad de hotel</option>
...
<option value="premium">premium</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Buscar hotel</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-car" aria-hidden="true"></i> Hoteles listados recientemente</h5>
          </div>
